...
for roi = 1:n_rois
    ...
    if nnz(num2str(roi))==1
        xlswrite(['D:\VHI\Analysis\ROI_analysis\Tables\ModelA\1stLevel_movCor2_5s_2_6mm_run_illusion\table_roi0' num2str(roi) '.xlsx'],mat_values);
    else
        xlswrite(['D:\VHI\Analysis\ROI_analysis\Tables\ModelA\1stLevel_movCor2_5s_2_6mm_run_illusion\table_roi' num2str(roi) '.xlsx'],mat_values);
    end
end
delete(h)