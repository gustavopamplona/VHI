...
for roi = 10:n_rois
    ...
    if nnz(num2str(roi))==1
        xlswrite(['D:\VHI\Analysis\ROI_analysis\Tables\ModelB\1stLevel_modelB3\table_roi0' num2str(roi) '.xlsx'],mat_values);
    else
        xlswrite(['D:\VHI\Analysis\ROI_analysis\Tables\ModelB\1stLevel_modelB3\table_roi' num2str(roi) '.xlsx'],mat_values);
    end
end
delete(h)