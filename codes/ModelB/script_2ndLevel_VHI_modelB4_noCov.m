...
% update 16.06.2023 - no 2nd level covariates
...
for cond = 1:7
    ...
    if  ~(cond == 3 | cond >= 5) % if conditions 1, 2 3, or 5
        load('D:\VHI\Analysis\ModelB\batch_2ndLevel_VHI_modelB1_noCov.mat')
    else
        load('D:\VHI\Analysis\ModelB\batch_2ndLevel_VHI_modelB2_noCov.mat')
    end
